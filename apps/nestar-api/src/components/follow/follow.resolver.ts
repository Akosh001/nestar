...
import { shapeIntoMongoObjestId } from '../../libs/config';
...
export class FollowResolver {
	...
	public async subscribe(@Args('input') input: string, @AuthMember('_id') memberId: ObjectId): Promise<Follower> {
		...
		const followingId = shapeIntoMongoObjestId(input);
	...
	public async getMemberFollowings(
		...
		input.search.followerId = shapeIntoMongoObjestId(followerId);
	...
	public async getMemberFollowers(
		...
		input.search.followingId = shapeIntoMongoObjestId(followingId);
